...
public class AdminLoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        if(username.equals("ebiudang7")){
            startActivity(new Intent(AdminLoginActivity.this, MainActivity.class));
            finish();
        }
        else if(username.equals("tambakudang1")){
            startActivity(new Intent(AdminLoginActivity.this, MainActivityUser.class));
            finish();
        }
        else if(username.equals("tambakudang2")){
            startActivity(new Intent(AdminLoginActivity.this, MainActivityUser.class));
            finish();
        }
        else if(username.equals("tambakudang3")){
            startActivity(new Intent(AdminLoginActivity.this, MainActivityUser.class));
            finish();
        }
        else{
